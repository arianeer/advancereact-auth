//authenticate user when they visit a route
...
const localLogin = new LocalStrategy(localOptions, function (
  ...
  //verfiy this username and password, call done with the user
...
//create jwt strategy
//payload = decoded jwt token (sub and iat properties) done = callback function
